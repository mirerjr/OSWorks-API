...
public class ClienteController {
	...
	@GetMapping("/nomes")
	public List<Cliente> listarPorNome(@RequestBody Cliente cliente) {
		 //FIXME: Add Status code 404
		return clienteRepository.findByNome(cliente.getNome());
	}
		
	@GetMapping("/termos")
	public List<Cliente> listarPorTermos(@RequestBody Cliente cliente) {
		 //FIXME: Add Status code 404
		return clienteRepository.findByNomeContaining(cliente.getNome());
	}
